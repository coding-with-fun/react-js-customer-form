...
const App = () => {
    ...
    useEffect(() => {
        ...
        if (
            initialUserValues.order_no &&
            initialUserValues.product_name &&
            initialUserValues.email_address &&
            initialUserValues.token
        ) {
    ...
    return (
        <div className="container mt-5">
            {!submittedValues ? (
                    ...
                    <form className="row g-3 border p-3 m-4">
                        ...
                        <div className="container mb-3">
                            ...
                            >
                                ...
                                <option>
                                    Between 9am to 6pm (Applied for 7th to 10th
                                    May, 12th 2021)
                                </option>
                            </select>
                            <div
                ...
                <div className="submitted-form-screen">
                    You have successfully submitted the form. Our team will
                    contact you soon.
                </div>
            )}
        </div>
